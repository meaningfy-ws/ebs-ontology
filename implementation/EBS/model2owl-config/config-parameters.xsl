...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
    ...
    <xsl:variable name="base-ontology-uri" select="'http://ebs-integrator.com/ontology/erp'"/>
    <xsl:variable name="base-shape-uri" select="'http://ebs-integrator.com/ontology/erp/data-shape'"/>
